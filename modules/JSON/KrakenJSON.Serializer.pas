...
type TKrakenSerializer<T: class, constructor> = class(TKrakenBase, IKrakenSerializer<T>)
  ...
  public
    ...
    class function New(bUseIgnore: Boolean): IKrakenSerializer<T>;
...
constructor TKrakenSerializer<T>.create(bUseIgnore: Boolean);
begin
  inherited create;
  FUseIgnore := bUseIgnore;
end;

destructor TKrakenSerializer<T>.Destroy;
begin

  inherited;
end;

function TKrakenSerializer<T>.JsonArrayToList(Value: TJSONArray): TObjectList<T>;
var
  i: Integer;
begin
...
procedure TKrakenSerializer<T>.jsonObjectToObject(AObject: TObject; AJsonObject: TJSONObject; AType: TRttiType);
var
...
procedure TKrakenSerializer<T>.jsonObjectToObject(AObject: TObject; AJsonObject: TJSONObject);
var
  rttiType: TRttiType;
begin
...
function TKrakenSerializer<T>.JsonObjectToObject(AJsonObject: TJSONObject): T;
begin
  result := T.create;
  JsonObjectToObject(Result, AJsonObject);
end;

procedure TKrakenSerializer<T>.jsonObjectToObjectList(AObject: TObject; AJsonArray: TJSONArray; AProperty: TRttiProperty);
var
  i          : Integer;
  objectItem : TObject;
  value      : TValue;
...
function TKrakenSerializer<T>.JsonStringToList(Value: String): TObjectList<T>;
var
...
function TKrakenSerializer<T>.JsonStringToObject(AJsonString: String): T;
var
  json: TJSONObject;
begin
  result := nil;
...
class function TKrakenSerializer<T>.New(bUseIgnore: Boolean): IKrakenSerializer<T>;
begin
