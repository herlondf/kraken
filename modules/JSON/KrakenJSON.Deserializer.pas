...
type TKrakenDeserializer<T: class, constructor> = class(TKrakenBase, IKrakenDeserializer<T>)
  ...
  public
    ...
    class function New(bUseIgnore: Boolean = True): IKrakenDeserializer<T>;
...
destructor TKrakenDeserializer<T>.Destroy;
begin

  inherited;
end;

function TKrakenDeserializer<T>.StringToJsonObject(value: string): TJSONObject;
var
  json : string;
begin
...
function TKrakenDeserializer<T>.ListToJSONArray(Value: TObjectList<T>): TJSONArray;
var
  myObj: T;
begin
...
class function TKrakenDeserializer<T>.New(bUseIgnore: Boolean = True): IKrakenDeserializer<T>;
begin
  result := Self.create(bUseIgnore);
end;

function TKrakenDeserializer<T>.ObjectToJsonObject(Value: TObject): TJSONObject;
var
  jsonString: string;
begin
...
function TKrakenDeserializer<T>.ObjectToJsonString(Value: TObject): string;
var
  rttiType: TRttiType;
begin
...
procedure TKrakenDeserializer<T>.ProcessOptions(AJsonObject: TJSOnObject);
var
  LPair: TJSONPair;
  LItem: TObject;
  i: Integer;
...
function TKrakenDeserializer<T>.ValueListToJson(AObject: TObject; AProperty: TRttiProperty): string;
var
  rttiType: TRttiType;
  method  : TRttiMethod;
  value   : TValue;
...
function TKrakenDeserializer<T>.ValueToJson(AObject: TObject; AProperty: TRttiProperty): string;
var
  value : TValue;
  data  : TDateTime;
  listType: TRttiType;
...
function TKrakenDeserializer<T>.ObjectToJsonString(AObject: TObject; AType: TRttiType): string;
var
