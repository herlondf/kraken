...
type
  ...
  public
    ...
    ///<summary>Ignora o contador de referencia
    function TryGetItemWithoutRefCount(AId: Integer = -1): TPoolItem<T>;
  end;
...
function TPoolManager<T>.TryGetItemWithoutRefCount(AId: Integer): TPoolItem<T>;
var
  I: Integer;
  LPoolItem: TPoolItem<T>;
  LInstance: T;
