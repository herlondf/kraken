...
type TJSONParserDeserializer<T: class, constructor> = class(TJSONParserBase, IJSONParserDeserializer<T>)
...
function TJSONParserDeserializer<T>.StringToJsonObject(value: string): TJSONObject;
var
  json : string;
begin
...
function TJSONParserDeserializer<T>.ListToJSONArray(Value: TObjectList<T>): TJSONArray;
var
  myObj: T;
begin
...
function TJSONParserDeserializer<T>.ObjectToJsonString(Value: TObject): string;
var
  rttiType: TRttiType;
begin
...
procedure TJSONParserDeserializer<T>.ProcessOptions(AJsonObject: TJSOnObject);
var
  LPair: TJSONPair;
  LItem: TObject;
  i: Integer;
...
function TJSONParserDeserializer<T>.ValueListToJson(AObject: TObject; AProperty: TRttiProperty): string;
var
  rttiType: TRttiType;
  method  : TRttiMethod;
  value   : TValue;
...
function TJSONParserDeserializer<T>.ValueToJson(AObject: TObject; AProperty: TRttiProperty): string;
var
  value : TValue;
  data  : TDateTime;
begin
...
function TJSONParserDeserializer<T>.ObjectToJsonString(AObject: TObject; AType: TRttiType): string;
var
